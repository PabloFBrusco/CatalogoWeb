<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPablo.Master" AutoEventWireup="true" CodeBehind="DetalleArticulo.aspx.cs" Inherits="Presentacion.DetalleArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row row-cols-2">
            ...
            <div class="col-8">
                ...
                <div>
                    <a href="Catalogo.aspx" class="btn btn-primary btn-sm botones">Volver</a>
                </div>
